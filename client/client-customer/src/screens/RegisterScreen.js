...
export default function RegisterScreen(props) {
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', backgroundColor: "#9dc9a8", paddingHorizontal: 10, alignContent: "center" }}>
      <ScrollView contentContainerStyle={{ paddingTop: 80, justifyContent: 'center', paddingHorizontal: 10, alignContent: "center" }}>
        <View style={{ alignSelf: 'center' }}>
          <Text style={{ fontSize: 25, fontWeight:"bold" }}>Register Here!</Text>
        </View>
        <TextInput
          mode="outlined"
          label="Name"
